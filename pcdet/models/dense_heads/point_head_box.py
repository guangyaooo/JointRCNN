...
class PointHeadBox(PointHeadTemplate):
    ...
    def assign_targets(self, input_dict):
        ...
        targets_dict = self.assign_stack_targets(
            ...
            ret_part_labels=False, ret_box_labels=True,self_training_mode=input_dict.get('self_training_mode', False)
        )
    ...
    def get_loss(self, tb_dict=None):
        ...
        if 'point_box_labels' in self.forward_ret_dict and not self.forward_ret_dict.get('ignore_box_loss', False):

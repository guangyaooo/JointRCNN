...
class ProposalTargetLayer(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        ignored_rois = (batch_gt_of_rois[:, :, -1] == -1) if self_training_mode else None
    ...
    def sample_rois_for_rcnn(self, batch_dict):
        ...
        for index in range(batch_size):
            ...
            if self.roi_sampler_cfg.get('SAMPLE_ROI_BY_EACH_CLASS', False) and\
                    not batch_dict.get('self_training_mode', False):
